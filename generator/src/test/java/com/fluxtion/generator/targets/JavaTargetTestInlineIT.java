...
public class JavaTargetTestInlineIT {
    ...
    public void test_1NoFilter() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(Test1NoFilter);
    ...
    public void trace_int_0_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test1);
    ...
    public void trace_int_0_test2() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test2);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test3() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test3);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test4() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test4);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test5() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test5);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_subclass_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_subclass_test1);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_diamond_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_diamond_test1);
...
//        JavaTestGeneratorHelper.testTraceIdOrder(((TraceEvent.TraceEvent_sub1)te).getTraceIdList(), "sub1", "sub1.1");
    ...
    public void trace_dirty_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_dirty_test1);
        //
    ...
    public void trace_dirty_test3() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_dirty_test2);
        //
        TraceEvent.TraceEvent_sub1 te = new TraceEvent.TraceEvent_sub1(1);
        te.strValue = "no match";
        handler.onEvent(te);
    ...
    public void trace_eventlifecycle_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_eventlifecycle_test1);
        //
        TraceEvent.TraceEvent_sub1 te = new TraceEvent.TraceEvent_sub1(1);
        handler.onEvent(te);
    ...
    public void trace_0_test1() throws Exception {
        ...
        EventHandler handler = JavaTestGeneratorHelper.sepInstanceInline(trace_0_test1);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
