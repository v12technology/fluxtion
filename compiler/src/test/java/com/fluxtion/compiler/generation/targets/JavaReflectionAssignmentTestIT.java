...
//                addPublicNode(new Handler_TraceEvent_PrivateMembers("private", "transient", 100, -200,'k', parent), "testNode");
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstance(JavaGeneratorNames.test_privateAssignment);
    ...
    public void test_dispatchWithReflectionAssignment() throws Exception{
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstance(JavaGeneratorNames.test_privateDispatch);
