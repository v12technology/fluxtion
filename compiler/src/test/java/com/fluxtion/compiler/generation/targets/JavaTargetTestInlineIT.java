...
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.Test1Filtered;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.Test1NoFilter;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_0_test1;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_diamond_test1;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_dirty_test1;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_dirty_test2;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_eventlifecycle_test1;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_int_0_test1;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_int_0_test2;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_int_0_test3;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_int_0_test4;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_int_0_test5;
import static com.fluxtion.compiler.generation.targets.JavaGeneratorNames.trace_subclass_test1;
 ...
 *
 * JavaTestGeneratorHelper.sepInstanceInline replacing:
 * JavaTestGeneratorHelper.sepInstance
 *
 * @author Greg Higgins
 */
public class JavaTargetTestInlineIT {

    @Test
    public void test_1NoFilter() throws Exception {
        //System.out.println("test_1NoFilter");
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(Test1NoFilter);
    ...
    public void test1NoIdEventFilter() throws Exception {
        ...
        Object newInstance = JavaTestGeneratorHelper.sepInstanceInline(Test1Filtered);
    }

    @Test
    public void trace_int_0_test1() throws Exception {
        //System.out.println("trace_int_0_test1");
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test1);
    ...
    public void trace_int_0_test2() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test2);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test3() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test3);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test4() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test4);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_int_0_test5() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_int_0_test5);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_subclass_test1() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_subclass_test1);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
        TraceEvent_InFilter_0 event = new TraceEvent_InFilter_0(10);
    ...
    public void trace_diamond_test1() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_diamond_test1);
...
//        JavaTestGeneratorHelper.testTraceIdOrder(((TraceEvent.TraceEvent_sub1)te).getTraceIdList(), "sub1", "sub1.1");
    ...
    public void trace_dirty_test1() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_dirty_test1);
        //
    ...
    public void trace_dirty_test3() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_dirty_test2);
        //
        TraceEvent.TraceEvent_sub1 te = new TraceEvent.TraceEvent_sub1(1);
        te.strValue = "no match";
        handler.onEvent(te);
    ...
    public void trace_eventlifecycle_test1() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_eventlifecycle_test1);
        //
        TraceEvent.TraceEvent_sub1 te = new TraceEvent.TraceEvent_sub1(1);
        handler.onEvent(te);
    ...
    public void trace_0_test1() throws Exception {
        ...
        StaticEventProcessor handler = JavaTestGeneratorHelper.sepInstanceInline(trace_0_test1);
        //ensure root field exists
        JavaTestGeneratorHelper.testPublicField(handler, "aggregator");
        //filter matches on 10, check trace
