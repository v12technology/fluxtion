 ...
 */
package com.fluxtion.runtim.audit;
...
public interface Auditor extends Lifecycle {
     ...
     * called before the event nodes {@link com.fluxtion.runtim.annotations.AfterEvent}'s are processed
     * <p>
     * Normally the {@link #processingComplete()} will be called following all the nodes
     * annotated with {@link com.fluxtion.runtim.annotations.AfterEvent} have been invoked.
     */
