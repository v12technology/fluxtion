 ...
 */
package com.fluxtion.extension.declarative.funclib.builder.csv;
...
import static com.fluxtion.extension.declarative.funclib.builder.Templates.CSV_MARSHALLER;
...
public class RecordParserBuilder<P extends RecordParserBuilder<P, T>, T> {
    ...
    public <S, U extends Boolean> P validator(int colIndex, LambdaReflection.SerializableFunction<S, U> validatorFunction) {
//        Method method = validatorFunction.method();
//        Class<?> declaringClass = method.getDeclaringClass();
//        System.out.println(method);
//        if (Modifier.isStatic(method.getModifiers())) {
//            importMap.addStaticImport(declaringClass);
//            colInfo(colIndex).setValidator(method);
//        }
//        return (P) this;
