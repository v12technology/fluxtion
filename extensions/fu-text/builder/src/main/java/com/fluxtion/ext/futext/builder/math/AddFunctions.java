...
public interface AddFunctions {
    ...
    public static  < S extends Number, T, V extends Number> NumericValue add(S op1, T supplier2, SerializableSupplier accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(op1);
    ...
    public static  < S extends Number, T, V extends Number> NumericValue add(S op1, T supplier2, SerializableSupplier accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(op1);
        functionBuilder.input(supplier2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S extends NumericValue, T, V extends Number> NumericValue add(S op1, T supplier2, SerializableSupplier accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(op1);
        functionBuilder.input(supplier2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S extends NumericValue, T, V extends Number> NumericValue add(S op1, T supplier2, SerializableSupplier accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(op1);
        functionBuilder.input(supplier2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S extends Event, T, V extends Number> NumericValue add(Class<S> eventClass1, Function<S, Number> accessor1, T supplier2, SerializableSupplier accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(eventClass1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S extends Event, T, V extends Number> NumericValue add(Class<S> eventClass1, Function<S, Number> accessor1, T supplier2, SerializableSupplier accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(eventClass1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, T, V extends Number> NumericValue add(Wrapper<S> handler1, Function<S, Number> accessor1, T supplier2, SerializableSupplier accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(handler1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S, T, V extends Number> NumericValue add(Wrapper<S> handler1, Function<S, Number> accessor1, T supplier2, SerializableSupplier accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(handler1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, U extends Number, T extends Number> NumericValue add(S supplier1, SerializableSupplier accessor1, T op2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
    ...
    public static  < S, U extends Number, T extends Number> NumericValue add(S supplier1, SerializableSupplier accessor1, T op2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(op2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, U extends Number, T extends NumericValue> NumericValue add(S supplier1, SerializableSupplier accessor1, T op2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(op2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S, U extends Number, T extends NumericValue> NumericValue add(S supplier1, SerializableSupplier accessor1, T op2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(op2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, U extends Number, T extends Event> NumericValue add(S supplier1, SerializableSupplier accessor1, Class<T> eventClass2, Function<T, Number> accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(eventClass2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S, U extends Number, T extends Event> NumericValue add(S supplier1, SerializableSupplier accessor1, Class<T> eventClass2, Function<T, Number> accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(eventClass2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, U extends Number, T> NumericValue add(S supplier1, SerializableSupplier accessor1, Wrapper<T> handler2, Function<T, Number> accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(handler2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S, U extends Number, T> NumericValue add(S supplier1, SerializableSupplier accessor1, Wrapper<T> handler2, Function<T, Number> accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(handler2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
    ...
    public static  < S, U extends Number, T, V extends Number> NumericValue add(S supplier1, SerializableSupplier accessor1, T supplier2, SerializableSupplier accessor2) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        NumericValue function = functionBuilder.build();
    ...
    public static  < S, U extends Number, T, V extends Number> NumericValue add(S supplier1, SerializableSupplier accessor1, T supplier2, SerializableSupplier accessor2, Object resetNotifier) throws Exception {
        NumericFunctionBuilder functionBuilder = NumericFunctionBuilder.function(Add.class);
        functionBuilder.input(supplier1, accessor1);
        functionBuilder.input(supplier2, accessor2);
        functionBuilder.resetNotifier(resetNotifier);
