 ...
 */
public class PartitioningCollectionFieldMapper extends AbstractFilterWrapper {
    ...
    public <T, K, R, S> PartitioningCollectionFieldMapper(Wrapper<Collection<T>> targetInstance,
    ...
    public boolean mapPartitionedField() {
        final Collection collection = (Collection) targetInstance.event();
