...
public class GroupFunctionsBuilder {
    ...
    public static <S, K, V extends Number, R extends Number> GroupBy<Tuple<K, Number>> groupByCalc(
        ...
        Class<Tuple<K, Number>> tupleClass = Tuple.generify();
        SerializableBiConsumer<Tuple<K, Number>, ? super Byte> consumer = tupleSetRef(Tuple::setValue);
        GroupBy<Tuple<K, Number>> build = Group.groupBy(wrapper, tupleClass, keySupplier)
            .init(keySupplier, Tuple::setKey)
            .initCopy(Tuple::copyKey)
     ...
     *
     * The function processes inputs and produces any output type. The function parameters are:
     * <ol>
     * <li> The new value to be processed as a number
     * <li> The result from the previous calculation
     * </ol>
     ...
     *
     * The instance function processes inputs and produces any output type. The function parameters are:
     * <ol>
     * <li> The new value to be processed as a number
     * <li> The result from the previous calculation
     * </ol>
    ...
    /**
     * Applies a numeric static or instance function to an incoming field. The previous value is not provided as an
     * argument. The results are grouped by the key provider.
     *
     * The function processes {@link Number) inputs and produces a primitive or {@link Number} outputs. The function
     * parameters are:
     * <ol>
    ...
    /**
     * Applies an instance function to an incoming event. The previous value is not provided as an argument. The results
     * are grouped by the key provider.
     *
     * The instance function processes inputs and produces any output type. The function parameters are:
     * <ol>
     * <li> The new value to be processed as a number
    ...
    public static <S, K, V, R> GroupBy<Tuple<K, R>> groupByCalcComplex(
        ...
        Class<Tuple<K, R>> tupleClass = Tuple.generify();
        GroupBy<Tuple<K, R>> build = Group.groupBy(wrapper, tupleClass, keySupplier)
            .init(keySupplier, Tuple::setKey)
            .initCopy(Tuple::copyKey)
            .map(valueSupplier, Tuple::setValue, func )
            .build();
    ...
    public static <K, S, T extends Number> GroupBy<Tuple<K, Number>> groupBySum(
        ...
        return groupByCalc(wrapper, key, supplier, cumSum());
    }
