...
public class WrappedCollectionGroupByTest extends StreamInprocessTest{
    ...
    public void resetGroup(){
        sep((c) ->{
            ...
            largeOrdersByCcy.build().id("orderSummaryCollection")
        ...
        assertThat(summaryCollection.collection().size(), is(2));
        HashMap<String, OrderSummary> orderMap = new HashMap<>();
        summaryCollection.collection().forEach(os -> orderMap.put(os.getCcyPair(), os));
        ...
        assertThat( summaryCollection.collection().size(), is(0));
