 ...
 * @author Greg Higgins
 */
public class MutableNumericValue<T> implements NumericValue<T>{
    ...
    public boolean equals(Object obj) {
        ...
        final MutableNumericValue<?> other = (MutableNumericValue<?>) obj;
    ...
    public String toString() {
        return "MutableNumericValue{" + "intValue=" + intValue + ", longValue=" + longValue + ", doubleValue=" + doubleValue + ", underlying=" + underlying + '}';
    }
