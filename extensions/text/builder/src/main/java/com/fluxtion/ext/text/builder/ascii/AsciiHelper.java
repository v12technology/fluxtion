...
import com.fluxtion.ext.text.api.ascii.Ascii2DoubleTerminator;
...
import com.fluxtion.ext.text.api.ascii.Csv2ByteBuffer;
import com.fluxtion.ext.text.api.ascii.Csv2ByteBufferStringBuilder;
import com.fluxtion.ext.text.api.ascii.Csv2Double;
import com.fluxtion.ext.text.api.ascii.Csv2Value;
...
public interface AsciiHelper {
     ...
     * @return
     */
    static Ascii2IntTerminator readInt(String searchFilter, String terminator, Object notifier) {
    ...
    static Ascii2DoubleTerminator readDouble(String searchFilter, String terminator, Object notifier) {
     ...
     */
    static ByteBufferDelimiter wordSplitter() {
     ...
     * @return ByteBufferDelimiter
     */
    static ByteBufferDelimiter wordSplitter(String delimiterChars, String ignoredChars) {
     ...
     * @return
     */
    static Ascii2IntTerminator readInt(String searchFilter, String terminator) {
        return readInt(searchFilter, terminator, null);
    }

    static Ascii2DoubleTerminator readDouble(String searchFilter, String terminator) {
     ...
     * @return
     */
    static Ascii2IntTerminator readInt(String searchFilter) {
        final Ascii2IntTerminator ascii2Int = new Ascii2IntTerminator(null, searchFilter);
        GenerationContext.SINGLETON.getNodeList().add(ascii2Int);
        return ascii2Int;
    }

    static Ascii2DoubleTerminator readDouble(String searchFilter) {
    ...
    //CSV METHODS
    static Csv2Value readIntCsv(int fieldId) {
...
//        return csvIntReader;
    ...
    static Csv2Value readDoubleCsv(int fieldId) {
...
//        return csvIntReader;
    ...
    static BufferValue readBytesCsv(int fieldId) {
        return readBytesDelimited(fieldId, ",", 0);
    }

    static BufferValue readCharSeqCsv(int fieldId) {
        return readCharSeqDelimited(fieldId, ",", 0);
    }
    
    static Csv2Value readIntCsv(int fieldId, int headerLines) {
        return readIntDelimited(fieldId, ",", headerLines);
    }

    static Csv2Value readDoubleCsv(int fieldId, int headerLines) {
        return readDoubleDelimited(fieldId, ",", headerLines);
    }

    static BufferValue readBytesCsv(int fieldId, int headerLines) {
        return readBytesDelimited(fieldId, ",", headerLines);
    }
    
    static BufferValue readCharSeqCsv(int fieldId, int headerLines) {
        return readCharSeqDelimited(fieldId, ",", headerLines);
    }

    //GENERIC DELIMITED METHODS
    static Csv2Value readIntDelimited(int fieldId, String delimiters) {
//        Csv2Value csvIntReader = new Csv2Value(fieldId, delimiters, 0);
//        GenerationContext.SINGLETON.getNodeList().add(csvIntReader);
        return readIntDelimited(fieldId, delimiters, 0);
    }

    static Csv2Value readDoubleDelimited(int fieldId, String delimiters) {
//        Csv2Value csvIntReader = new Csv2Value(fieldId, delimiters, 0);
//        GenerationContext.SINGLETON.getNodeList().add(csvIntReader);
        return readDoubleDelimited(fieldId, delimiters, 0);
    }

    static BufferValue readBytesDelimited(int fieldId, String delimiters) {
        return readBytesDelimited(fieldId, delimiters, 0);
    }

    static Csv2Value readIntDelimited(int fieldId, String delimiters, int headerLines) {
        Csv2Value csvIntReader = new Csv2Value(fieldId, delimiters, headerLines);
        GenerationContext.SINGLETON.getNodeList().add(csvIntReader);
        return csvIntReader;
    }

    static Csv2Value readDoubleDelimited(int fieldId, String delimiters, int headerLines) {
        Csv2Double csvIntReader = new Csv2Double(fieldId, delimiters, headerLines);
        GenerationContext.SINGLETON.getNodeList().add(csvIntReader);
        return csvIntReader;
    }

    static BufferValue readBytesDelimited(int fieldId, String delimiters, int headerLines) {
    ...
    static BufferValue readCharSeqDelimited(int fieldId, String delimiters, int headerLines) {
     ...
     * @return
     */
    static Ascii2IntFixedLength readIntFixedLength(String searchFilter, int length, Object notifier) {
     ...
     * @return
     */
    static Ascii2IntFixedLength readIntFixedLength(String searchFilter, int length) {
        return readIntFixedLength(searchFilter, length, null);
    }

    static Ascii2DoubleFixedLength readDoubleFixedLength(String searchFilter, int length, Object notifier) {
        final Ascii2DoubleFixedLength ascii2Int = new Ascii2DoubleFixedLength(notifier, (byte) length, searchFilter);
        GenerationContext.SINGLETON.getNodeList().add(ascii2Int);
        return ascii2Int;
    }

    static Ascii2DoubleFixedLength readDoubleFixedLength(String searchFilter, int length) {
