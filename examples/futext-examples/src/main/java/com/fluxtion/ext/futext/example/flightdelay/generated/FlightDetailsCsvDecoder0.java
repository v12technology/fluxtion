...
public class FlightDetailsCsvDecoder0 implements RowProcessor<FlightDetails> {
  ...
  private void logException(String prefix, boolean fatal, Exception e) {
    errorLog
        ...
        .append(" fieldIndex:'")
        .append(fieldIndex)
        .append("' targetMethod:'FlightDetails#")
  ...
  public static void asCsv(FlightDetails src, StringBuilder msgSink) throws IOException {
    msgSink.append(src.getDelay());
    //msgSink.append("\n");
  }

  public static void asCsv(FlightDetails src, Appendable target) throws IOException {
  ...
  @Override
  public Appendable toCsv(FlightDetails src, Appendable target) throws IOException {
    msgSink.setLength(0);
    asCsv(src, msgSink);
